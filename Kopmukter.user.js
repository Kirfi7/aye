...
const buttons = [
    ...
    {
	  title: 'Передать жалобу на рассмотрение тех. специалисту',
	  content:
		'[SIZE=5][FONT=Georgia][CENTER]Здравствуйте, уважаемый игрок.[/CENTER]<br><br>' +
	...
	},
    {
	  title: 'Био одобрена',
	  content:
		'[SIZE=5][FONT=Georgia][CENTER]Здравствуйте, уважаемый игрок.[/CENTER][/FONT][/SIZE]<br><br>' +
        "[SIZE=5][FONT=Georgia][CENTER]Ваша биография одобрена.[/CENTER][/FONT][/SIZE]<br><br>" +
		'[SIZE=5][FONT=Georgia][CENTER]Одобрено, закрыто.[/CENTER][/FONT][/SIZE]',
	  prefix: OKAY_PREFIX,
	  status: false,
	},
    {
	  title: 'Био отказана',
	  content:
		'[SIZE=5][FONT=Georgia][LEFT]Здравствуйте, уважаемый игрок.[/CENTER]<br><br>' +
